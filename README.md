# Weelo Microfrontend Properties

This microfrontend shows the main page with properties, here the user can interact with all functionalities about properties

- Property List
- Search Properties (using filtering and pagination)
...
```sh
cd weelo-microfronted-properties
npm i
npm start
```
